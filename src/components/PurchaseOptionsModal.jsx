...
export default function PurchaseOptionsModal({
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center overflow-y-auto bg-[#171b1a]/75 px-3 py-5 backdrop-blur-sm sm:px-6 sm:py-8">
      <div className="absolute inset-0" onClick={onClose} aria-hidden="true" />
      <section className="relative z-10 w-full max-w-5xl overflow-hidden rounded-3xl border border-white/70 bg-[#fcfbf7] px-5 py-7 shadow-[0_24px_80px_rgba(0,0,0,0.28)] sm:rounded-[1.75rem] sm:px-9 sm:py-8 lg:px-10 lg:py-9">
          ...
          <article className="relative flex flex-col rounded-[1.35rem] border border-[#f7bd7c]  p-6 shadow-[0_8px_24px_rgba(133,57,48,0.05)] transition hover:-translate-y-0.5 hover:shadow-[0_14px_30px_rgba(133,57,48,0.11)] sm:p-7">
            ...
            <div className="flex items-start justify-between">
              <div>
                ...
                <h3 className="mt-3 max-w-60 font-georgia text-xl md:text-2xl leading-[1.05] tracking-[-0.03em] text-[#171b19]">Let Our Expert Team Customize It for You</h3>
              </div>
