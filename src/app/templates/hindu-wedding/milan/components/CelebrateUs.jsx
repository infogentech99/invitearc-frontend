 ...
 useEffect(() => {
    ...
    return (
        ...
        <div className="h-180 md:h-300 lg:h-325 3xl:h-421 flex flex-col items-center relative">
          ...
          <h2 className="font-eb-garamond font-medium text-base md:text-3xl pt-6 md:pt-17 lg:pt-15 3xl:pt-25 text-[#D99447]">
            {data.blessingTitle}
          </h2>
          <h2 className="font-eb-garamond font-medium text-sm md:text-[26px] text-center pt-5 md:pt-5 lg:pt-10 text-[#D99447] lg:w-280 md:w-200">
          ...
          <p className="font-eb-garamond font-medium text-xs md:text-[22px] text-center mt-2 text-[#D99447]">
          ...
          <p className="font-eb-garamond font-medium text-base md:text-[22px] text-center mt-4 text-[#D99447]">
            {data.venue}
          </p>
