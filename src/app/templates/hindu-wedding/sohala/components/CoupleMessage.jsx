...
export default function CoupleMessage({ data }) {
  ...
  return (
    <section
      className="bg-[url('/assets/respo_third.webp')] md:bg-[url('/assets/background_third.webp')] bg-cover bg-no-repeat bg-top md:bg-center w-full overflow-hidden"
      style={{ backgroundImage: `url(${coupleBg})` }}
    >
      <div className="h-505 md:h-560 lg:h-950 3xl:h-1182">
        <h1 className="eb-garamond font-medium text-[24px] md:text-2xl lg:text-[38px] text-center text-[#FFFFFF] lg:pt-40 pt-20">
          {coupleTitle}
        </h1>
        ...
        <div className="relative flex flex-col items-center mt-14 md:mt-16 lg:mt-20 3xl:mt-50">
          <img
            src={data?.coupleMessageImages?.image1 || assets.couple_one}
            alt="couple_one"
            className=" absolute lg:top-0 w-32 h-25 md:w-47 md:h-37 lg:w-108 lg:h-76 3xl:w-120 3xl:h-88 z-10"
          />
          <div className="flex flex-col ">
            <h2 className="flex flex-col items-center text-center text-xl md:text-4xl lg:text-[68px] ml-58 md:ml-92 lg:ml-192 3xl:ml-230 md:mt-2 3xl:mt-6">
              <span className="eb-garamond font-medium text-[#F2AD15] ">
                {data.groomName}
              </span>
              <span className="eb-garamond font-medium text-[#7CE670] opacity-50 text-5xl md:text-7xl lg:text-[124px] -my-5 md:-my-8 lg:-my-12 pr-8 md:pr-12 lg:pr-30">
                &
              </span>
              <span className="eb-garamond font-medium text-[#F2AD15] pr-6 md:pr-10 lg:pr-20">
                {data.brideName}
              </span>
            </h2>
          </div>
          <img
            src={data?.coupleMessageImages?.image2 || assets.couple_two}
            alt="couple_two"
            className="absolute top-15 left-12 w-28 h-45 md:top-25 md:left-35 md:w-50 md:h-65 
                      lg:top-50 lg:left-50 lg:w-108 lg:h-126 3xl:top-60 3xl:left-70 3xl:w-130 3xl:h-180 z-0"
          />
          <img
            src={assets.flowers}
            alt="flowers"
            className="ml-2 mt-2 w-24 h-30 md:w-40 md:h-46 lg:w-58 lg:h-96 3xl:w-90 3xl:h-118 3xl:mt-7 3xl:ml-26 z-40"
          />
          <img
            src={data?.coupleMessageImages?.image3 || assets.couple_three}
            alt="couple_three"
            className="absolute top-17 right-12 w-28 h-48 md:top-25 md:right-40 md:w-50 md:h-75 
                      lg:top-55 lg:right-50 lg:w-108 lg:h-146 3xl:top-60 3xl:right-65 3xl:w-140 3xl:h-200 z-20"
          />
          <img
            src={data?.coupleMessageImages?.image4 || assets.couple_four}
            alt="couple_four"
            className="mt-2 w-33 h-25 md:w-60 md:h-40 lg:w-123 lg:h-96 lg:mt-8 3xl:mt-20 3xl:w-140 3xl:h-108 3xl:mr-15 z-10"
          />
        </div>
        ...
        <div className="lg:mt-20 3xl:mt-40" id="rsvp-section">
          {rsvpMode === "form" ? (
            <div className="flex flex-col items-center text-center">
              <h2 className="eb-garamond font-normal text-center text-xl md:text-4xl lg:text-[50px] 3xl:text-[64px] text-[#FFFFFF] pt-26 md:pt-90 lg:pt-85 3xl:pt-150 leading-6 md:leading-8 lg:leading-15 pr-26 md:pr-90 lg:pr-155 lg:w-350 lg:px-0 md:px-20">
                {rsvpSectionHeading}
              </h2>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              >
                ...
                <span className="eb-garamond font-normal text-xs md:text-[15px] lg:text-[22px] text-[#FFFFFF] pr-30 md:pr-70 lg:mr-90">
                  {rsvpButtonText}
                </span>
              </a>
            </div>
