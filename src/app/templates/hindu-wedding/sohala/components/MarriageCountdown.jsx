...
export default function MarriageCountdown() {
    ...
    useEffect(() => {
        const updateCountdown = () => {
            ...
            if (diff <= 0) {
                setTimeLeft({ days: 30, hours: 10, minutes: 20 });
                return;
            }
        ...
        <>
            <div className="bg-[url('/assets/background_fifth.webp')] bg-cover bg-no-repeat pb-12" style={{ backgroundImage: `url(${assets.background_fifth})` }}>
                <div className="flex flex-col items-center h-60 md:h-100 lg:h-150 3xl:h-195 gap-2 md:gap-4 lg:gap-4 3xl:gap-14">
                    <h2 className="parisienne-regular font-normal text-2xl md:text-4xl lg:text-6xl text-center text-[#FFFFFF] pt-10 md:pt-20 lg:pt-30 3xl:pt-55">The Journey Begins</h2>
