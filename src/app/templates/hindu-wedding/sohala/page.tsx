      ...
      <RoseHeroTemp />
        <div className="pt-12 md:pt-34 lg:pt-64 relative z-10">
          ...
          <h2 className="text-[#FFFFFF] text-center leading-tight text-3xl md:text-5xl lg:text-[64px] pb-130 md:pb-220 lg:pb-400
            ...
            <span className="eb-garamond font-medium">SAMPATH</span>

            <span className="jacques-francois font-normal text-xl md:text-3xl lg:text-5xl tracking-widest">WEDS</span>

            <span className="eb-garamond font-medium">SAYALI</span>
          ...
          <div className="mt-8 text-center">
            ...
            <p className="eb-garamond font-medium text-[#FFFFFF] text-sm md:text-xl lg:text-3xl mt-6">
              Daughter of Shri Mahesh Joshi & Shrimati Asha Joshi
            </p>
      ...
      <section className="bg-[url('/assets/respo_third.webp')] md:bg-[url('/assets/background_third.webp')] bg-cover bg-no-repeat bg-top md:bg-center w-full overflow-hidden" style={{ backgroundImage: `url(${coupleBg})` }}>
        ...
        <div className="h-505 md:h-517 lg:h-956 3xl:h-1182">
          ...
          <div className="relative flex flex-col items-center mt-14 md:mt-16 lg:mt-20 3xl:mt-50">
            <img src={assets.couple_one} alt="couple_one" className=" absolute lg:top-0 w-32 h-25 md:w-47 md:h-37 lg:w-108 lg:h-76 3xl:w-120 3xl:h-88 z-10" />
            <div className="flex flex-col ">
              <h2 className="flex flex-col items-center text-center text-xl md:text-4xl lg:text-[68px] ml-58 md:ml-92 lg:ml-192 3xl:ml-230 md:mt-2 3xl:mt-6">
                <span className="eb-garamond font-medium text-[#F2AD15] ">SAMPATH</span>
                ...
                <span className="eb-garamond font-medium text-[#F2AD15] pr-6 md:pr-10 lg:pr-20">SAYALI</span>
              </h2>
            </div>
            <img src={assets.couple_two} alt="couple_two" className="absolute top-15 left-12 w-28 h-45 md:top-25 md:left-35 md:w-50 md:h-65 
            ...
            <img src={assets.couple_three}  alt="couple_three" className="absolute top-17 right-12 w-28 h-48 md:top-25 md:right-40 md:w-50 md:h-75 
                      lg:top-55 lg:right-50 lg:w-108 lg:h-146 3xl:top-60 3xl:right-65 3xl:w-140 3xl:h-200 z-20" />
            <img src={assets.couple_four}  alt="couple_four" className="mt-2 w-33 h-25 md:w-60 md:h-40 lg:w-123 lg:h-96 lg:mt-8 3xl:mt-20 3xl:w-140 3xl:h-108 3xl:mr-15 z-10" />
          </div>
          ...
          <div className="lg:mt-20 3xl:mt-40">
            ...
            <div className="flex flex-col-1 justify-center items-center md:not-first:mt-2 pr-30 md:pr-70 lg:mr-90">
              <a href="#" target="_blank">
                <img src={assets.whatsapp} alt="whatsapp" className="w-7.5 h-7.5 md:w-10 md:h-10 lg:w-10.5 lg:h-10.5 3xl:w-15 3xl:h-15 lg:mt-1" />
              </a>
