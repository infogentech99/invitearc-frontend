    ...
    <>
      ...
      >
        <div className="flex flex-col items-center h-180 md:h-210 lg:h-400 3xl:h-400 md:gap-3 lg::gap-8 3xl:gap-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 justify-center items-center gap-6 md:gap-20 lg:gap-24 md:mt-4 lg:mt-0">
            ...
            >
              <div className="flex flex-col leading-none">
                <span className="font-eb-garamond font-normal text-3xl md:text-5xl lg:text-[82px] text-center text-[#E1B340]">
              {timeLeft.days}
                </span>
                <span className="font-eb-garamond font-normal text-xs md:text-base lg:text-[22px] text-center text-[#E1B340]">
                 DAYS  </span>
              </div>
            </div>
            <div
          ...
          <div
            className="flex justify-center bg-[url('/assets/countdown_frame.webp')] bg-cover bg-no-repeat bg-center w-94 h-73 md:w-162 md:h-126 lg:w-230 lg:h-178 mt-10 md:mt-0 lg:mt-20"
          ...
          >
            <div className="flex flex-col justify-center items-center mt-2 lg:mt-4">
              ...
              <p className="font-eb-garamond font-medium text-xs md:text-base lg:text-[22px] mt-2 md:mt-8 text-center text-[#E1B340]">
