    ...
    >
      <div className="h-630 md:h-744 lg:h-1141 3xl:h-1200">
        ...
        <div className="relative flex flex-col mt-10 md:mt-10 lg:mt-20">
          <h2 className="absolute font-eb-garamond font-medium text-[20px] md:text-4xl lg:text-[60px] 3xl:text-[68px] text-center text-[#A25000] 3xl:left-50 lg:left-0 md:left-20">
            <span className="absolute font-eb-garamond font-medium top-5 left-13 md:top-16 md:left-23 lg:top-6 lg:left-60">
              {data.groomName}
            </span>
            <br />
            <span className="absolute font-eb-garamond font-medium text-4xl md:text-7xl lg:text-[150px] text-[#DF5200] top-10 left-22 md:top-19 md:left-37 lg:top-13 lg:left-78 -rotate-20 opacity-50">
              &
            </span>
            <br />
          ...
          <img
            ...
            alt="couple_one"
            className="absolute top-23 left-10 w-44 h-50 
                       md:w-85 md:h-106 md:top-48 md:left-40 lg:w-167 lg:h-158 lg:top-60 lg:left-49 3xl:top-60 3xl:left-100 z-20"
          />
          <img
            src={data?.coupleMessageImages?.image2 || assets.two}
            alt="couple_two"
            className="absolute top-6 right-10 w-40 h-50
          ...
          <img
            ...
            alt="couple_three"
            className="absolute top-72 left-12 w-40 h-50 
          ...
          <img
            ...
            alt="couple_four"
            className="absolute top-60 right-8 w-46 h-44
                       md:w-102 md:h-98 md:top-125 md:right-20 lg:w-2xl lg:h-148 lg:top-175 lg:right-45 3xl:right-80 z-30"
          />
        </div>

        <h1 className="font-parisienne-regular font-normal text-5xl md:text-6xl lg:text-[100px] text-center pt-140 md:pt-280 lg:pt-400 leading-tight text-[#A25000] md:px-0 px-8">
          {thingsToKnowTitle}
        </h1>
        ...
        <h2 className="font-eb-garamond font-normal text-xl md:text-2xl lg:text-3xl text-center px-6 md:pt-4 lg:pt-10 lg:mt-4 lg:leading-tight text-[#A25000] 3xl:px-100 lg:px-40 md:px-30">
          ...
          <div className="flex flex-col-1 md:gap-0 gap-0 lg:gap-0 justify-center items-center 3xl:w-180">
            {rsvpMode === "form" ? (
              <div className="flex flex-col items-center text-center">
                <h2 className="font-eb-garamond font-normal text-center text-2xl md:text-3xl lg:text-[54px] text-[#A25000] leading-normal md:leading-8 lg:leading-12 pt-15 md:pt-40 lg:pt-50 3xl:pt-80 ">
                  {rsvpSectionHeading}
                </h2>
              ...
              <div className="flex flex-col items-center text-center">
                <h2 className="font-eb-garamond font-normal text-center text-2xl md:text-3xl lg:text-[54px] text-[#A25000] pt-15 md:pt-40 lg:pt-50 3xl:pt-80 leading-normal md:leading-8 lg:leading-12 ">
                  {rsvpSectionHeading}
                </h2>
                ...
                >
                  ...
                  <span className="font-eb-garamond font-normal text-[16px] md:text-lg lg:text-[22px] text-[#A25000]">
                    {rsvpButtonText}
                  </span>
                </a>
              </div>
