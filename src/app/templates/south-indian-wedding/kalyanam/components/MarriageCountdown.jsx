        ...
        <>
            <div className="bg-cover bg-no-repeat md:pb-12" style={{backgroundImage: `url(${assets.bg_last})`}}>
                <div className="flex flex-col items-center h-70 md:h-92 lg:h-130 3xl:h-183 gap-2 md:gap-4 lg:gap-4">
                    ...
                    <hr className="w-42 md:w-66 lg:w-94 border lg:border-2 border-[#FFF5B9] my-1 md:my-1 lg:my-2" />
                    <h2 className="eb-garamond font-normal text-2xl md:text-4xl lg:text-[62px] text-center text-[#FFF5B9]"> {timeLeft.days}D - {timeLeft.hours}H - {timeLeft.minutes}M</h2>
