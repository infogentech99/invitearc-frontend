...
//                     <h2 className="parisienne-regular text-2xl md:text-4xl lg:text-[60px] text-center text-[#FFD74B] pt-4 md:pt-11 lg:pt-42 3xl:pt-55">The Journey Begins</h2>
//                     <p className="eb-garamond font-medium text-xs md:text-xl lg:text-[32px] text-[#FFD74B] mt-4 text-center px-6 md:px-25 lg:px-65 3xl:px-120">
//                         Surrounded by family and friends, we can't wait to celebrate <br />
//                         this beautiful moment with you.
//                     </p> 
//                     <h2 className="eb-garamond font-normal text-xl md:text-4xl lg:text-[52px] text-center text-[#FFD74B]"> {timeLeft.days}D {timeLeft.hours}H {timeLeft.minutes}M</h2>
